...
namespace EksiSozluk.Infrastructure.Persistence.Context
{
    ...
    {
        private static List<User> GetUsers()             // KISACA ÖZET: Önce git user oluştur bu userlerın ıd sini al entry oluştur entrydeki userıdleri kullan 
        {                                                       // Sonra EntryComment oluştur ve oluşturuyorkende rastgele bir user ve entry seç EntryCommentteki kodlarda açıklanmıştır.
                                                                        // en sonda ise bunları götür veritabanında çalıştır en son kodda gösterilmiştir.
        ...
        public async Task SeedAsync(IConfiguration configuration)
        {
            ...
            dbContextBuilder.UseSqlServer(configuration["EksiSozlukDbConnectionString"]);
